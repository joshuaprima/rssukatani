          ...
          <div class="box-tools pull-right">
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="Number" class="form-control" name="UserName" placeholder="Enter Amount" required>
                </div>
                <div class="form-group">
            ...
            <div class="box-footer">
                ...
                Change & Generate Request
              </button>
            </div>
        <div class="box-footer">
            <i class="fa fa-commenting pull-left"></i>
            <small class="pull-left"> <i class="pull-left">The invoice will be created after the changes occur. If you want to donwload the invoice again simply don't change anything</i></small>
          <br>
        </div>
        </div>
      </div>
